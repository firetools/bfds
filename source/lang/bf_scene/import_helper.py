...
def sc_from_fds_list(context, sc, fds_list, set_tmp=False, texts=(), filename=None):
    ...
    for bf_namelist in managed_bf_namelists:
        ...
        log.debug(f"Import {managed_fds_label} namelists...")

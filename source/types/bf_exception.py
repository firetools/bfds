...
"""!
BFDS, general utilities and exception types.
"""


class BFException(Exception):
    """!
    Exception raised by BFDS methods in case of an error.
    """
...
class BFNotImported(BFException):
    """!
    Exception raised by BFDS methods when some FDS importing fails.
    """
